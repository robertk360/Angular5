...
using Angular5.ViewModels;
using Angular5.Helpers;
using Angular5.Authorization;
...
namespace Angular5
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.UseSqlServer(Configuration["ConnectionStrings:DefaultConnection"], b => b.MigrationsAssembly("Angular5"));
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                c.SwaggerDoc("v1", new Info { Title = "Angular5 API", Version = "v1" });
            });
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "Angular5 API V1");
            });
